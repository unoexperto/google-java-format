...
public final class Formatter {
  ...
  public static final int MAX_LINE_LENGTH_ALL = 100;
  ...
  static void format(final JavaInput javaInput, JavaOutput javaOutput, JavaFormatterOptions options)
    ...
    doc.computeBreaks(javaOutput.getCommentsHelper(), options.maxCodeLineLength(), new Doc.State(+0, 0));
  ...
  public String formatSourceAndFixImports(String input) throws FormatterException {
    ...
    formatted = StringWrapper.wrap(options.maxCodeLineLength(), formatted, this);
    return formatted;
  }
